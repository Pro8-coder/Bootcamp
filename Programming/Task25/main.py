...
def reg():
    ...
    if form.validate_on_submit():
        ...
        with open(r'Programming\Task25\file.txt', 'a', encoding='utf-8') as file:
...
def log():
    form = AuthF()
    if form.validate_on_submit():
        with open(r'Programming\Task25\file.txt', 'r', encoding='utf-8') as file:
